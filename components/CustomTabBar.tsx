...
export function CustomTabBar({ routes }: CustomTabBarProps) {
    ...
    const hideBottomTabBarRoutes = ['userSettings','adminHome', 'createPTW', 'createIncidentReport', 'createCommunicationReport', 'approved','communicationRecord','completed', 'hseInspection','incidentReporting', 'profile','rejected','inReview','editProfile','changePassword','notification'];
