...
export function CustomTabBar({ routes }: CustomTabBarProps) {
    ...
    const hideBottomTabBarRoutes = ['adminHome', 'createPTW', 'createIncidentReport', 'createCommunicationReport', 'approved','communicationRecord','completed', 'hseInspection','incidentReporting', 'profile','rejected','inReview','editProfile','changePassword','notification'];
