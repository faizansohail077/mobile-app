...
const ButtonComponent = ({ disabled, title,onPress }: {onPress?:()=>void, title: string, disabled?: boolean }) => {
    return (
        <TouchableOpacity disabled={disabled} onPress={onPress} activeOpacity={0.8} style={[styles.buttonContainer, { backgroundColor: disabled ? Colors.disabled : Colors.primary_blue }]} >
