...
const IncidentReporting = () => {
  ...
  const tags = [{ text: "Incident Reporting", color: Colors.dark_red }, { text: "Near Miss", color: Colors.light_grey }]
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ paddingTop: heightPercentageToDP(2) }} >
          ...
          <View style={{ gap: 10 }} >
            ...
            <TouchableOpacity activeOpacity={0.7} style={styles.documentContainer} >
              <View style={{ flexDirection: 'row', gap: 5 }} >
                ...
                <View>
                  <Text style={{ color: "rgba(69, 69, 69, 1)", fontWeight: '500' }} >B42KPQ.pdf</Text>
                  <Text style={{ color: "rgba(69, 69, 69, 1)" }}>200 KB</Text>
                </View>
              </View>
              <SvgXml xml={Images.download()} />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.navigationTopContainer}>
          <View style={{ gap: 10 }} >
            ...
            <View style={[{ gap: 10, marginTop: heightPercentageToDP(1) }]} >
              <Text style={styles.keyText}>Corrective action raised: </Text>
              <Text style={[styles.valueText, { lineHeight: heightPercentageToDP(2.5) }]}>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</Text>
            </View>

            <View style={[{ gap: 10, marginTop: heightPercentageToDP(1) }]} >
              <Text style={styles.keyText}>Prevention action raised: </Text>
              <Text style={[styles.valueText, { lineHeight: heightPercentageToDP(2.5) }]}>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</Text>
            </View>
