...
import { tab_list, user_role } from '@/constants/user';
      ...
      {user?.role === user_role["Admin"] ?
        <View style={styles.topContainer} >
          <View style={styles.topSubContainer} >
            <AntDesign onPress={() => router.push({ 'pathname': '/adminHome' })} name="left" size={24} color="black" />
            <Text style={styles.headerText}>{item?.title ? item?.title?.length > 20 ? `${item?.title.slice(0,20)}...`:item?.title:"LTA PL208 - CYCLING ..."}</Text>
